...
import { contactInfo, socialLinks } from '@/data/personal-links';
			...
			<div className="space-y-6">
				...
				<div className="text-xl text-zinc-400 space-y-4 max-w-2xl">
					<p>
						...
						JavaScript technologies and have a passion for creating
						intuitive user interfaces.
					</p>
					<p>
						When I&apos;m not coding, you can find me contributing
						to open-source projects, writing technical articles, or
